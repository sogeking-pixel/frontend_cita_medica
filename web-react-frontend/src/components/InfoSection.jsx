  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-center gap-10 px-4 md:px-6 lg:px-12 py-12 ">
      ...
      <div className="grid grid-cols-2 gap-4 md:gap-6 flex-1 w-full">
        {/* Columna 1 */}
        <div className="flex flex-col gap-4 md:gap-6 -translate-y-8 translate-x-2 md:-translate-y-10">
         {/* Segundo cuadro con Lottie */}
          <div className="w-5/6 h-40 sm:h-90 bg-white rounded-3xl shadow-lg flex items-center justify-center">
       ...
       <div className="flex flex-col gap-4 md:gap-6 translate-y-8 translate-x-4 md:-translate-x-2  md:translate-y-30">
            {/* Segundo cuadro con Lottie */}
          <div className="w-5/6 h-40 sm:h-90 bg-white rounded-3xl shadow-lg flex items-center justify-center">
