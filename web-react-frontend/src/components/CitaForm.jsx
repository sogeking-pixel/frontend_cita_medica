      ...
      <div className="bg-white rounded-3xl shadow-2xl p-6 w-full max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
          ...
          <div className="md:col-span-2">
            <label className="block text-[#404040] text-xl mb-3">Especialidad</label>
            <select
              name="specialty"
          ...
          {/* Fecha */}
          <div className="md:col-span-2">
            <label className="block text-[#6a6a6a] text-xl mb-3 ">Elige fecha de asistencia</label>
            <input
              type="date"
              name="date"
              value={formData.date}
          ...
          <div className="md:col-span-1 flex justify-end mt-9">
            ...
            >
              <img src={lupa} alt="Buscar" className="w-6 h-5 rounded-full shadow-lg" />
              Buscar
            </button>
          </div>
