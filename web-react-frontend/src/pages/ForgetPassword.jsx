          ...
          <div className="max-w-md mx-auto">
            ...
            {!enlaceEnviado ? (
              <div className="flex flex-col items-center text-center">
                ...
                <h1 className="text-3xl font-semibold mb-2">¿Olvidaste tu contraseña?</h1>
                ...
                <div className="w-full ">
                  ...
                  <Button className="w-full mt-12 mb-5 text-lg  " onClick={handleRecuperar}>
                    Enviar enlace
                  </Button>
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <h1 className="text-3xl font-semibold mb-2 mt-5">¡Listo! Revisa tu correo</h1>
                <p className="text-gray-500 text-[17px] font-outfit font-medium mb-4">
                  Hemos enviado un enlace a <span className="font-semibold text-gray-700">{email}</span> para restablecer tu contraseña.
                </p>
                <div>
                    <Lottie animationData={EmailConfirmation} style={{ height: 150 }} loop={true}/>
                </div>

                <Button className="w-full my-4 text-lg" onClick={() => (window.location.href = "/")}>
                Volver al inicio de sesión
                </Button>
